    ...
    <form onSubmit={handleSubmit} className='space-y-8 pb-12'>
      <div className='grid gap-6'>
        <Card className='border-none shadow-sm glass'>
          <CardHeader>
            <CardTitle className='text-xl font-bold'>Employee Information</CardTitle>
            <CardDescription>Basic professional and personal details.</CardDescription>
          </CardHeader>
          <CardContent className='grid gap-6'>
            <div className='grid md:grid-cols-2 gap-4'>
              ...
              <div className='grid gap-2'>
                ...
                />
                {errors.staffNumber && (
                  <p className='text-xs text-rose-500'>{errors.staffNumber[0]}</p>
                )}
              </div>
            </div>
            ...
            <div className='grid md:grid-cols-2 gap-4'>
              <div className='grid gap-2'>
                ...
                />
                {errors.designation && (
                  <p className='text-xs text-rose-500'>{errors.designation[0]}</p>
                )}
              </div>
              <div className='grid gap-2'>
                ...
                />
                {errors.department && (
                  <p className='text-xs text-rose-500'>{errors.department[0]}</p>
                )}
              </div>
            </div>
            ...
            <div className='grid md:grid-cols-3 gap-4'>
              ...
              <div className='grid gap-2'>
                ...
                />
                {errors.joiningDate && (
                  <p className='text-xs text-rose-500'>{errors.joiningDate[0]}</p>
                )}
              </div>
            </div>
          </CardContent>
        ...
        <Card className='border-none shadow-sm glass'>
          <CardHeader>
            <CardTitle className='text-xl font-bold'>Portal Access & Contact</CardTitle>
            <CardDescription>Credentials and contact info for the employee.</CardDescription>
          </CardHeader>
          <CardContent className='grid gap-6'>
            {!initialData && (
        ...
        <Card className='border-none shadow-sm glass'>
          <CardHeader>
            <CardTitle className='text-xl font-bold'>Employment & Payroll</CardTitle>
            <CardDescription>Contractual and financial details.</CardDescription>
          </CardHeader>
          <CardContent className='grid gap-6'>
            <div className='grid md:grid-cols-2 gap-4'>
              <div className='grid gap-2'>
              ...
              <div className='grid gap-2'>
                ...
                {errors.baseSalary && (
                  <p className='text-xs text-rose-500'>{errors.baseSalary[0]}</p>
                )}
              </div>
            </div>
            <div className='grid md:grid-cols-2 gap-4'>
