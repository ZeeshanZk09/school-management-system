    ...
    <div className='space-y-6 animate-in fade-in duration-500'>
      <div className='flex flex-col md:flex-row md:items-center justify-between gap-4'>
        <div className='space-y-1'>
          <h1 className='text-3xl font-bold tracking-tight font-outfit'>Staff Management</h1>
                ...
                >
                  ...
                  <TableCell>
                    <Badge
                      variant='outline'
                      className={
                        EMPLOYMENT_TYPE_STYLES[staff.employmentType] ||
                        EMPLOYMENT_TYPE_STYLES.PART_TIME
                      }
                    >
