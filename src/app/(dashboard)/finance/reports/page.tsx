        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-slate-50/50 dark:bg-slate-900/50 border-y">
              <TableHead>
                {type === "collection" ? "Date" : "Student"}
              </TableHead>
              <TableHead>
                {type === "collection" ? "Student" : "Class"}
              </TableHead>
              <TableHead>
                {type === "collection" ? "Class" : "Total Due"}
              </TableHead>
              <TableHead>
                {type === "collection" ? "Method" : "Outstanding"}
              </TableHead>
            ...
            {reportData.length === 0 ? (
              ...
              reportData.map((row) => (
                ...
                >
                  ...
                  <TableCell>
                    {type === "collection" ? row.student : row.class}
                  </TableCell>
                  <TableCell>
                    {type === "collection"
                      ? row.class
