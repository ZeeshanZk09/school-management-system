 ...
 *
 */
export type OneTimeTokenModel =
  runtime.Types.Result.DefaultSelection<Prisma.$OneTimeTokenPayload>;
...
export type OneTimeTokenAggregateArgs<
  ExtArgs extends
...
> = {
   ...
   */
  orderBy?:
    | Prisma.OneTimeTokenOrderByWithRelationInput
    | Prisma.OneTimeTokenOrderByWithRelationInput[];
  /**
...
export type OneTimeTokenGroupByArgs<
  ExtArgs extends
    runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  where?: Prisma.OneTimeTokenWhereInput;
  orderBy?:
    | Prisma.OneTimeTokenOrderByWithAggregationInput
    | Prisma.OneTimeTokenOrderByWithAggregationInput[];
...
type GetOneTimeTokenGroupByPayload<T extends OneTimeTokenGroupByArgs> =
...
export type OneTimeTokenWhereInput = {
  ...
  identifier?: Prisma.StringFilter<"OneTimeToken"> | string;
  tokenHash?: Prisma.StringFilter<"OneTimeToken"> | string;
  type?: Prisma.EnumTokenTypeFilter<"OneTimeToken"> | $Enums.TokenType;
  expiresAt?: Prisma.DateTimeFilter<"OneTimeToken"> | Date | string;
  consumedAt?:
    | Prisma.DateTimeNullableFilter<"OneTimeToken">
    | Date
    | string
    | null;
  requestedIp?: Prisma.StringNullableFilter<"OneTimeToken"> | string | null;
  createdAt?: Prisma.DateTimeFilter<"OneTimeToken"> | Date | string;
  isDeleted?: Prisma.BoolFilter<"OneTimeToken"> | boolean;
};
...
export type OneTimeTokenScalarWhereWithAggregatesInput = {
  AND?:
    | Prisma.OneTimeTokenScalarWhereWithAggregatesInput
    | Prisma.OneTimeTokenScalarWhereWithAggregatesInput[];
  ...
  identifier?: Prisma.StringWithAggregatesFilter<"OneTimeToken"> | string;
  tokenHash?: Prisma.StringWithAggregatesFilter<"OneTimeToken"> | string;
  type?:
    | Prisma.EnumTokenTypeWithAggregatesFilter<"OneTimeToken">
    | $Enums.TokenType;
  expiresAt?:
    | Prisma.DateTimeWithAggregatesFilter<"OneTimeToken">
    | Date
    | string;
  consumedAt?:
    | Prisma.DateTimeNullableWithAggregatesFilter<"OneTimeToken">
    | Date
    | string
    | null;
  requestedIp?:
    | Prisma.StringNullableWithAggregatesFilter<"OneTimeToken">
    | string
    | null;
  createdAt?:
    | Prisma.DateTimeWithAggregatesFilter<"OneTimeToken">
    | Date
    | string;
  isDeleted?: Prisma.BoolWithAggregatesFilter<"OneTimeToken"> | boolean;
};
...
export type OneTimeTokenSelect<
  ExtArgs extends
    runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
...
export type OneTimeTokenSelectCreateManyAndReturn<
  ExtArgs extends
    runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = runtime.Types.Extensions.GetSelect<
  {
...
export type OneTimeTokenSelectUpdateManyAndReturn<
  ExtArgs extends
    runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = runtime.Types.Extensions.GetSelect<
  {
...
export type OneTimeTokenGetPayload<
  S extends boolean | null | undefined | OneTimeTokenDefaultArgs,
> = runtime.Types.Result.GetResult<Prisma.$OneTimeTokenPayload, S>;

export type OneTimeTokenCountArgs<
  ExtArgs extends
    runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = Omit<
  OneTimeTokenFindManyArgs,
  "select" | "include" | "distinct" | "omit"
> & {
  select?: OneTimeTokenCountAggregateInputType | true;
};

export interface OneTimeTokenDelegate<
  ExtArgs extends
    runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
  GlobalOmitOptions = {},
> {
  [K: symbol]: {
    types: Prisma.TypeMap<ExtArgs>["model"]["OneTimeToken"];
    meta: { name: "OneTimeToken" };
  };
  /**
   ...
   * })
   */
  findUnique<T extends OneTimeTokenFindUniqueArgs>(
    args: Prisma.SelectSubset<T, OneTimeTokenFindUniqueArgs<ExtArgs>>,
  ): Prisma.Prisma__OneTimeTokenClient<
    runtime.Types.Result.GetResult<
      Prisma.$OneTimeTokenPayload<ExtArgs>,
      T,
      "findUnique",
      GlobalOmitOptions
    > | null,
   ...
   * })
   */
  findUniqueOrThrow<T extends OneTimeTokenFindUniqueOrThrowArgs>(
    args: Prisma.SelectSubset<T, OneTimeTokenFindUniqueOrThrowArgs<ExtArgs>>,
  ): Prisma.Prisma__OneTimeTokenClient<
    runtime.Types.Result.GetResult<
      Prisma.$OneTimeTokenPayload<ExtArgs>,
      T,
   ...
   * })
   */
  findFirst<T extends OneTimeTokenFindFirstArgs>(
    args?: Prisma.SelectSubset<T, OneTimeTokenFindFirstArgs<ExtArgs>>,
  ): Prisma.Prisma__OneTimeTokenClient<
    runtime.Types.Result.GetResult<
      Prisma.$OneTimeTokenPayload<ExtArgs>,
      T,
   ...
   * })
   */
  findFirstOrThrow<T extends OneTimeTokenFindFirstOrThrowArgs>(
    args?: Prisma.SelectSubset<T, OneTimeTokenFindFirstOrThrowArgs<ExtArgs>>,
  ): Prisma.Prisma__OneTimeTokenClient<
    runtime.Types.Result.GetResult<
      Prisma.$OneTimeTokenPayload<ExtArgs>,
      T,
   ...
   *
   */
  findMany<T extends OneTimeTokenFindManyArgs>(
    args?: Prisma.SelectSubset<T, OneTimeTokenFindManyArgs<ExtArgs>>,
  ): Prisma.PrismaPromise<
    runtime.Types.Result.GetResult<
      Prisma.$OneTimeTokenPayload<ExtArgs>,
      T,
   ...
   *
   */
  create<T extends OneTimeTokenCreateArgs>(
    args: Prisma.SelectSubset<T, OneTimeTokenCreateArgs<ExtArgs>>,
  ): Prisma.Prisma__OneTimeTokenClient<
    runtime.Types.Result.GetResult<
      Prisma.$OneTimeTokenPayload<ExtArgs>,
      T,
   ...
   *
   */
  createMany<T extends OneTimeTokenCreateManyArgs>(
    args?: Prisma.SelectSubset<T, OneTimeTokenCreateManyArgs<ExtArgs>>,
   ...
   *
   */
  createManyAndReturn<T extends OneTimeTokenCreateManyAndReturnArgs>(
    args?: Prisma.SelectSubset<T, OneTimeTokenCreateManyAndReturnArgs<ExtArgs>>,
  ): Prisma.PrismaPromise<
    runtime.Types.Result.GetResult<
      Prisma.$OneTimeTokenPayload<ExtArgs>,
      T,
   ...
   *
   */
  delete<T extends OneTimeTokenDeleteArgs>(
    args: Prisma.SelectSubset<T, OneTimeTokenDeleteArgs<ExtArgs>>,
  ): Prisma.Prisma__OneTimeTokenClient<
    runtime.Types.Result.GetResult<
      Prisma.$OneTimeTokenPayload<ExtArgs>,
      T,
   ...
   *
   */
  update<T extends OneTimeTokenUpdateArgs>(
    args: Prisma.SelectSubset<T, OneTimeTokenUpdateArgs<ExtArgs>>,
  ): Prisma.Prisma__OneTimeTokenClient<
    runtime.Types.Result.GetResult<
      Prisma.$OneTimeTokenPayload<ExtArgs>,
      T,
   ...
   *
   */
  deleteMany<T extends OneTimeTokenDeleteManyArgs>(
    args?: Prisma.SelectSubset<T, OneTimeTokenDeleteManyArgs<ExtArgs>>,
  ): Prisma.PrismaPromise<Prisma.BatchPayload>;
   ...
   *
   */
  updateMany<T extends OneTimeTokenUpdateManyArgs>(
    args: Prisma.SelectSubset<T, OneTimeTokenUpdateManyArgs<ExtArgs>>,
  ): Prisma.PrismaPromise<Prisma.BatchPayload>;
   ...
   *
   */
  updateManyAndReturn<T extends OneTimeTokenUpdateManyAndReturnArgs>(
    args: Prisma.SelectSubset<T, OneTimeTokenUpdateManyAndReturnArgs<ExtArgs>>,
  ): Prisma.PrismaPromise<
    runtime.Types.Result.GetResult<
      Prisma.$OneTimeTokenPayload<ExtArgs>,
      T,
   ...
   * })
   */
  upsert<T extends OneTimeTokenUpsertArgs>(
    args: Prisma.SelectSubset<T, OneTimeTokenUpsertArgs<ExtArgs>>,
  ): Prisma.Prisma__OneTimeTokenClient<
    runtime.Types.Result.GetResult<
      Prisma.$OneTimeTokenPayload<ExtArgs>,
      T,
    ...
    T extends runtime.Types.Utils.Record<"select", any>
      ? T["select"] extends true
        ...
        : Prisma.GetScalarType<
            T["select"],
            OneTimeTokenCountAggregateOutputType
          >
      : number
  >;
   ...
   * })
   **/
  aggregate<T extends OneTimeTokenAggregateArgs>(
    args: Prisma.Subset<T, OneTimeTokenAggregateArgs>,
  ): Prisma.PrismaPromise<GetOneTimeTokenAggregateType<T>>;
  ...
  >(
    args: Prisma.SubsetIntersection<T, OneTimeTokenGroupByArgs, OrderByArg> &
      InputErrors,
  ): {} extends InputErrors
    ? GetOneTimeTokenGroupByPayload<T>
 ...
 */
export interface Prisma__OneTimeTokenClient<
  T,
  Null = never,
  ExtArgs extends
    runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
...
export interface OneTimeTokenFieldRefs {
  ...
  readonly identifier: Prisma.FieldRef<"OneTimeToken", "String">;
  readonly tokenHash: Prisma.FieldRef<"OneTimeToken", "String">;
  readonly type: Prisma.FieldRef<"OneTimeToken", "TokenType">;
  readonly expiresAt: Prisma.FieldRef<"OneTimeToken", "DateTime">;
  readonly consumedAt: Prisma.FieldRef<"OneTimeToken", "DateTime">;
  readonly requestedIp: Prisma.FieldRef<"OneTimeToken", "String">;
  readonly createdAt: Prisma.FieldRef<"OneTimeToken", "DateTime">;
  readonly isDeleted: Prisma.FieldRef<"OneTimeToken", "Boolean">;
}
 ...
 */
export type OneTimeTokenFindUniqueOrThrowArgs<
  ExtArgs extends
    runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type OneTimeTokenFindFirstArgs<
  ExtArgs extends
    runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   ...
   */
  distinct?:
    | Prisma.OneTimeTokenScalarFieldEnum
    | Prisma.OneTimeTokenScalarFieldEnum[];
};
 ...
 */
export type OneTimeTokenFindFirstOrThrowArgs<
  ExtArgs extends
    runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 * OneTimeToken create
 */
export type OneTimeTokenCreateArgs<
  ExtArgs extends
    runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   ...
   */
  data: Prisma.XOR<
    Prisma.OneTimeTokenCreateInput,
    Prisma.OneTimeTokenUncheckedCreateInput
  >;
};
 ...
 */
export type OneTimeTokenCreateManyArgs<
  ExtArgs extends
    runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   ...
   */
  data:
    | Prisma.OneTimeTokenCreateManyInput
    | Prisma.OneTimeTokenCreateManyInput[];
 ...
 */
export type OneTimeTokenCreateManyAndReturnArgs<
  ExtArgs extends
    runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 * OneTimeToken update
 */
export type OneTimeTokenUpdateArgs<
  ExtArgs extends
    runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   ...
   */
  data: Prisma.XOR<
    Prisma.OneTimeTokenUpdateInput,
    Prisma.OneTimeTokenUncheckedUpdateInput
  >;
  /**
 ...
 */
export type OneTimeTokenUpdateManyArgs<
  ExtArgs extends
    runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
   ...
   */
  data: Prisma.XOR<
    Prisma.OneTimeTokenUpdateManyMutationInput,
    Prisma.OneTimeTokenUncheckedUpdateManyInput
  >;
  /**
 ...
 */
export type OneTimeTokenUpdateManyAndReturnArgs<
  ExtArgs extends
    runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 * OneTimeToken upsert
 */
export type OneTimeTokenUpsertArgs<
  ExtArgs extends
    runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 * OneTimeToken delete
 */
export type OneTimeTokenDeleteArgs<
  ExtArgs extends
    runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type OneTimeTokenDeleteManyArgs<
  ExtArgs extends
    runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
 ...
 */
export type OneTimeTokenDefaultArgs<
  ExtArgs extends
    runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs,
> = {
  /**
