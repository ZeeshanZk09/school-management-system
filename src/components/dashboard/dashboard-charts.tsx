    ...
    <div className='grid gap-8 lg:grid-cols-2'>
      ...
      <Card className='border-none shadow-sm glass overflow-hidden rounded-[2rem]'>
        <CardHeader className='p-8 pb-0'>
          ...
          <CardDescription className='font-medium'>Daily presence rate for the last 7 days.</CardDescription>
        </CardHeader>
      ...
      <Card className='border-none shadow-sm glass overflow-hidden rounded-[2rem]'>
        <CardHeader className='p-8 pb-0'>
          ...
          <CardDescription className='font-medium'>Students distributed across classes.</CardDescription>
        </CardHeader>
        <CardContent className='p-8 pt-4'>
